      ...
      <main className="flex-1">
        ...
        <section className="py-10 border-y border-border bg-muted/20">
          <div className="container mx-auto px-4 text-center">
            <p className="text-sm font-medium text-muted-foreground mb-6">الخيار الموثوق لأكثر من 20,000 سائق في المملكة، معتمد من:</p>
            <div className="flex flex-wrap justify-center gap-8 md:gap-16 items-center opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
              <span className="text-xl font-bold font-serif">ساعد للسيارات</span>
              <span className="text-xl font-bold font-serif">الجزيرة موتورز</span>
              <span className="text-xl font-bold font-serif">الورش المعتمدة</span>
              <span className="text-xl font-bold font-serif">تأمين كير</span>
              <span className="text-xl font-bold font-serif">موتور بلس</span>
            </div>
          </div>
        </section>
