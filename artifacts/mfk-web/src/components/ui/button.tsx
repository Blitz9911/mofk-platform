    ...
    variants: {
      variant: {
        default:
           ...
           "bg-primary text-primary-foreground border border-primary/80 shadow-[0_0_24px_rgba(255,101,0,0.16)]",
        destructive:
        ...
        outline:
          ...
          // No hover state
          " border border-border bg-card text-foreground shadow-none active:shadow-none ",
        secondary:
          // @replit border, no hover, no shadow, secondary border.
          "border bg-secondary text-secondary-foreground border-border ",
