...
function XIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.743l7.722-8.841L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
    </svg>
  );
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm leading-relaxed">
              منصة تشخيص السيارات الذكية الأولى في المملكة. حوّل سيارتك إلى مركبة ذكية، افهم الأعطال قبل تفاقمها.
            </p>
            <div className="flex items-center gap-3">
              <Button asChild variant="ghost" size="icon" className="rounded-full hover:text-primary hover:bg-primary/10">
                <a href="https://x.com/mfksa" target="_blank" rel="noopener noreferrer" aria-label="X">
                  <XIcon className="h-4 w-4" />
                </a>
              </Button>
              <Button asChild variant="ghost" size="icon" className="rounded-full hover:text-green-500 hover:bg-green-500/10">
                <a href="https://wa.me/966500000000" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                  <WhatsAppIcon className="h-5 w-5" />
                </a>
              </Button>
              <Button asChild variant="ghost" size="icon" className="rounded-full hover:text-primary hover:bg-primary/10">
                <a href="https://instagram.com/mfksa" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <Instagram className="h-5 w-5" />
                </a>
              </Button>
              <Button asChild variant="ghost" size="icon" className="rounded-full hover:text-primary hover:bg-primary/10">
                <a href="https://linkedin.com/company/mfksa" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
