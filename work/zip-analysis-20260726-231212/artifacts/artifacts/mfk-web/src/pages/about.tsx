...
const MILESTONES = [
  { year: "2021", title: "بداية الفكرة", desc: "نشأت فكرة مفك بعد تجربة شخصية مؤلمة — لمبة اشتغلت، وورش كثيرة أعطت أرقاماً مختلفة. كان لازم يتغير هذا الشي." },
          ...
          <div className="container mx-auto px-4 text-center max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                سوّينا مفك عشان ما تضيع بين كلام الورش —
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <motion.div {...fadeUp(0.1)} className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { title: "الورش تعطيك كلام مختلف", desc: "كل واحد يقول رقم مختلف وأنت في النص ضايع بين الآراء." },
                  ].map((item, i) => (
              ...
              <motion.div {...fadeUp(0.2)} className="space-y-6">
                ...
                <div className="space-y-3">
                  {[
                    "اعرف سبب العطل قبل ما تروح للورشة",
